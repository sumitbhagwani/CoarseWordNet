...
static char *Id = "$Id: morph.c,v 1.57 2001/06/08 17:20:43 wn Exp $";

static char *sufx[] ={ 
    /* Noun suffixes */
    "s", "ses", "xes", "zes", "ches", "shes", "men",
    /* Verb suffixes */
...
static int offsets[NUMPARTS] = { 0, 0, 7, 15 };
static int cnts[NUMPARTS] = { 0, 7, 8, 4 };
