/*
   ...
   $Id: wnconsts.h,v 1.66 2001/05/30 16:25:17 wn Exp $
...
#ifdef PC
#define DICTDIR         "\\dict"
#define DEFAULTPATH	"c:\\wn17\\dict"
#define DEFAULTBIN      "c:\\wn17\\bin"
...
#define LASTTYPE	NOMINALIZATIONS
...
#define WNESCORT	(LASTTYPE + 8)
#define WNGREP		(LASTTYPE + 9)
#define OVERVIEW	(LASTTYPE + 10)
