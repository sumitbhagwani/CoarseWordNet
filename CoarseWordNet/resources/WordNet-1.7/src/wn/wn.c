...
static char *Id = "$Id: wn.c,v 1.4 2001/06/19 15:06:17 wn Exp $";
...
static struct {
    ...
    { "-nomnn", NOMINALIZATIONS, NOUN, 11, "Nominalizations" },
    { "-attrn", ATTRIBUTE, NOUN, 12, "Attributes" },
    { "-famln", FREQ, NOUN, 13, "Familiarity" },
    { "-grepn", WNGREP, NOUN, 14, "Grep" },
    ...
    { "-hypev", -HYPERPTR, VERB, 4, "Synonyms/Hypernyms (Ordered by Frequency)" },
    ...
    { "-nomnv", NOMINALIZATIONS, VERB, 8, "Nominalizations" },
    { "-framv", FRAMES, VERB, 9, "Sample Sentences" },
    { "-famlv", FREQ, VERB, 10, "Familiarity" },
    { "-grepv", WNGREP, VERB, 11, "Grep" },
...
struct {
    ...
    { "-nomn%c",        "-nomn{n|v}",   "\t\tNominalizations",},
    ...
    { NULL, NULL, NULL },	/* wnescort - not used */
